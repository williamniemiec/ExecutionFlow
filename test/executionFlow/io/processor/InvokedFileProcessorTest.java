...
public class InvokedFileProcessorTest
{
	...
	{
		File currentDir = new File("tests/executionFlow/io/processor/files/InvokerFileProcessor");
	...
	{
		File currentDir = new File("tests/executionFlow/io/processor/files/InvokerFileProcessor/complex");
		String filename = "test_else";
		File f = new File(currentDir, filename+".java.txt");
	...
	{
		File currentDir = new File("tests/executionFlow/io/processor/files/InvokerFileProcessor/foreign");
