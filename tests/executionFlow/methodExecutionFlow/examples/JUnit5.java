...
public class JUnit5 
{
	...
	private static void init(Path pathBinTestMethod, Path pathSrcTestMethod, Object... testMethodArgs) throws IOException, ClassNotFoundException
	{
		...
		testMethodFileManager = new FileManager(
				pathSrcTestMethod,
			MethodInvokerInfo.getCompiledFileDirectory(pathBinTestMethod),
			PACKAGE_TEST_METHOD,
	...
	public void parameterizedTestAnnotation_test1_firstArg() throws Throwable 
	{
		...
		MethodInvokerInfo testMethodInfo = new MethodInvokerInfo.MethodInvokerInfoBuilder()
				.classPath(Path.of(ExecutionFlow.getAppRootPath(), "bin/examples/junit5/ParameterizedTestAnnotation.class"))
		...
		MethodInvokerInfo methodInfo = new MethodInvokerInfo.MethodInvokerInfoBuilder()
				.classPath(Path.of(ExecutionFlow.getAppRootPath(), "bin/examples/others/auxClasses/AuxClass.class"))
	...
	public void repeatedTestAnnotation_test1() throws Throwable 
	{
		...
		MethodInvokerInfo testMethodInfo = new MethodInvokerInfo.MethodInvokerInfoBuilder()
				.classPath(Path.of(ExecutionFlow.getAppRootPath(), "bin/examples/junit5/RepeatedTestAnnotation.class"))
				.methodSignature(testMethodSignature)
	...
	public void testAnnotation_test1() throws Throwable 
	{
		...
		MethodInvokerInfo testMethodInfo = new MethodInvokerInfo.MethodInvokerInfoBuilder()
				.classPath(Path.of(ExecutionFlow.getAppRootPath(), "bin/examples/junit5/TestAnnotation.class"))
				.methodSignature(testMethodSignature)
