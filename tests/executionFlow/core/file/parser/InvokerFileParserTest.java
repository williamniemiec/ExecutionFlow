...
@SkipCollection
public class InvokerFileParserTest
{/*
	@Test
	public void testEmptyClass() throws IOException
	{
		File currentDir = new File("tests/executionFlow/core/file/parser/files/InvokerFileParser");
		String filename = "test_empty";
		File f = new File(currentDir, filename+".java.txt");
		
		FileParser fp = new InvokerFileParser(f.toPath(), currentDir.toPath(), filename+"_parsed", "txt");
		fp.parseFile();
	}
	...
	public void testParseSwitch() throws IOException
	{
		...
		InvokerFileParser fp = new InvokerFileParser(f.toPath(), currentDir.toPath(), filename+"_parsed", FileEncoding.ISO_8859_1, "txt");
		fp.parseFile();
	}
	...
	{
		File currentDir = new File("tests/executionFlow/core/file/parser/files/InvokerFileParser/complex");
		String filename = "test_else";
		File f = new File(currentDir, filename+".java.txt");
	...
	public void testParseSwitch2() throws IOException
	{
		...
		FileParser fp = new InvokerFileParser(f.toPath(), currentDir.toPath(), filename+"_parsed", FileEncoding.ISO_8859_1, "txt");
		fp.parseFile();
	}
	...
	{
		File currentDir = new File("tests/executionFlow/core/file/parser/files/InvokerFileParser/foreign");
