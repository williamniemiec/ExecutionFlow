package auxfiles.wniemiec.app.executionflow.io.processing.manager;
import java.io.File;
import java.io.FileWriter;
import java.io.IOException;
public class testedinvoked {
private int number;
@wniemiec.app.executionflow.runtime.CollectCalls public testedinvoked(int x) {
number = x;
}
...
@wniemiec.app.executionflow.runtime.CollectCalls public synchronized void m4(int num){
someMethod();
}
...
@wniemiec.app.executionflow.runtime.CollectCalls private static void someMethod() {
}
}
