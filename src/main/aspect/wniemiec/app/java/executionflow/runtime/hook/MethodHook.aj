 ...
 * with {@link wniemiec.app.java.executionflow.runtime.SkipInvoked} annotation and all methods
 * from classes with {@link wniemiec.app.java.executionflow.runtime.SkipCollection} annotation.
 * 
