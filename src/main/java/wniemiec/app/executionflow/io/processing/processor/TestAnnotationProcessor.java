...
/**
 * Adds {@link wniemiec.app.executionflow.runtime.CollectMethodsCalled} annotation next to 
 * test annotations.
 * 
...
public class TestAnnotationProcessor extends SourceCodeProcessor {
	...
	protected String processLine(String line) {
		...
		return "@wniemiec.app.executionflow.runtime.CollectMethodsCalled" + " " + line + " ";
	}
	...
	private boolean hasCollectMethodAnnotation(String line) {
		return line.contains("@wniemiec.app.executionflow.runtime.CollectMethodsCalled");
	}
}
