...
/**
 * Adds {@link wniemiec.app.java.executionflow.runtime.CollectCalls} annotation in method and
...
public class InvokedProcessor extends SourceCodeProcessor {
	...
	protected String processLine(String line) {	
		...
		if (insideInvoked) {
			...
			processedLine = "@wniemiec.app.java.executionflow.runtime.CollectCalls " + line;
