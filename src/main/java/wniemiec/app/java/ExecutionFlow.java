...
import wniemiec.app.java.executionflow.exporter.ExportManager;
 ...
 * {@link wniemiec.app.java.executionflow.runtime.hook} is triggered.
 * 
...
public class ExecutionFlow {
	...
	private static Path getAppBinPath() {
		return urlToPath(ExecutionFlow.class.getResource("ExecutionFlow.class"));
	}
